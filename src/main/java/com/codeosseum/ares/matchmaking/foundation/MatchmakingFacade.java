...
import com.codeosseum.ares.matchmaking.foundation.matchmaker.MatchmakingResult;
...
public class MatchmakingFacade {
    ...
    @Autowired
    private List<Matchmaker<? extends MatchmakingProfile, ? extends MatchmakingResult>> matchmakers;
